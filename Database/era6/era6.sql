...
CREATE TABLE IF NOT EXISTS `mydb`.`object` (
  ...
  `obj_active` TINYINT NULL,
  `obj_GPS` VARCHAR(100) NULL,
  `obj_action` VARCHAR(100) NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`schedule` (
  ...
  `sch_tim_id` INT NULL,
  `sch_day_id` INT NULL,
  `sch_from_hour` TIME NULL,
  `sch_to_hour` TIME NULL,
